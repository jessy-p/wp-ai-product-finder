...
class Jessaipf_Admin_Settings {
	...
	public function render_api_section() {
		echo '<p>' . esc_html__( 'Configure your API keys for Pinecone and OpenAI services.', 'jessyp-ai-product-finder' ) . '</p>';
	}
	...
	public function render_chips_section() {
		echo '<p>' . esc_html__( 'Configure the suggestion chips displayed below the search input. Leave a field blank to hide that chip.', 'jessyp-ai-product-finder' ) . '</p>';
	}
	...
	public function render_suggestion_chips_field() {
		...
		for ( $i = 0; $i < 4; $i++ ) {
			...
			printf(
				...
				esc_attr( sprintf( __( 'Suggestion %d', 'jessyp-ai-product-finder' ), $i + 1 ) )
			);
		}
		echo '<p class="description">' . esc_html__( 'Enter up to 4 suggestion chip labels. Leave blank to hide a chip.', 'jessyp-ai-product-finder' ) . '</p>';
	}
	...
	public function render_index_section() {
		echo '<p>' . esc_html__( 'Information about your current Pinecone index. These fields are automatically populated when you create an index.', 'jessyp-ai-product-finder' ) . '</p>';
	}
	...
	public function render_sync_section() {
		echo '<p>' . esc_html__( 'Sync your WooCommerce products to Pinecone for AI-powered search. Make sure to configure your API settings above first.', 'jessyp-ai-product-finder' ) . '</p>';
	}
